...
// const tokenToBuy = 1000000;
// let totalTokens = 0;
// let plots = [];
// for (let index = 0; index < 793; index++) {
//   totalTokens+=tokenToBuy
//   const solQoute1 = amm.getSolFrom(tokenToBuy);
//   const point = {
//     tokenAmount: totalTokens,
//     solAmount: parseFloat(solQoute1.solReceived.toFixed(6)),
//   }
//   plots.push(point);
//   const buy1_solPaid = amm.buyViaTokenAmount(tokenToBuy); 
//   console.log("🚀 ~ buy1_solPaid:", buy1_solPaid)
//   amm.getState();
...
// const boughtToken1 = amm.buyTokens(0.0001);
